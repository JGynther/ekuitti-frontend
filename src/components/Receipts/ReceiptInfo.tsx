...
const ReceiptInfo: React.FC<ReceiptInfoProps> = ({ receipt }) => {
  ...
  return (
    <div
      onClick={() => handleOpen()}
      className="flex px-4 py-[10px] items-center justify-between border-2 border-white hover:border-grey hover:cursor-pointer"
    >
      {showDetails && (
        <ReceiptDetails
          receipt={receipt}
      ...
      <div className="flex">
        <div className="text-receipt font-bold mr-4">
